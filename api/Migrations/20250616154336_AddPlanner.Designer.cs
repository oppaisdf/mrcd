...
[Migration("20250616154336_AddPlanner")]
partial class AddPlanner
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("api.Models.Entities.Activity", b =>
            {
                b.Property<uint?>("Id")
                    .ValueGeneratedOnAdd()
        ...
        modelBuilder.Entity("api.Models.Entities.ActivityStage", b =>
            {
        ...
        modelBuilder.Entity("api.Models.Entities.PersonDocument", b =>
            {
                b.Property<int>("PersonId")
                    .HasColumnType("int");

                b.Property<short>("DocumentId")
                    .HasColumnType("smallint");
        ...
        modelBuilder.Entity("api.Models.Entities.StagesOfActivities", b =>
            {
                b.Property<uint>("ActivityId")
                    .HasColumnType("int unsigned");

                b.Property<ushort>("StageId")
                    .HasColumnType("smallint unsigned");
                ...
                b.HasKey("ActivityId", "StageId")
                    .HasName("PK_StagesOfActivities_ActivityId_StageId");

                b.HasIndex("StageId");

                b.ToTable("stagesofactivities");
            });
        ...
        modelBuilder.Entity("api.Models.Entities.PersonDocument", b =>
            {
                b.HasOne("api.Models.Entities.Document", null)
                    .WithMany()
        ...
        modelBuilder.Entity("api.Models.Entities.StagesOfActivities", b =>
            {
                b.HasOne("api.Models.Entities.Activity", null)
                    .WithMany()
                ...
                b.HasOne("api.Models.Entities.ActivityStage", null)
                    .WithMany()
